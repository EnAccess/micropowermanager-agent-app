...
@Parcelize
data class Transaction(@SerializedName("type") val type: String, @SerializedName("message") val message: String) : Parcelable
...
@Parcelize
data class Token(@SerializedName("token") val token: String) : Parcelable