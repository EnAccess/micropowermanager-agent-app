...
class LoginRepository(private val service: LoginService, private val preferences: SharedPreferenceWrapper) {

    fun login(email: String?, password: String?) =
        service.login(preferences.baseUrl + LOGIN_ENDPOINT, preferences.deviceId, LoginRequest(email, password))
