...
sealed class TicketFormUiState {
    data class OpenSummary(val summaryItems: ArrayList<KeyValue.Default>) : TicketFormUiState()

    data class ValidationError(val errors: List<Error>) : TicketFormUiState() {
        sealed class Error {
