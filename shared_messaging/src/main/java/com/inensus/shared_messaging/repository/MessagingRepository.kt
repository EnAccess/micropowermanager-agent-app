...
class MessagingRepository(
    ...
    fun resetFirebaseToken() {
        service
            .resetFirebaseToken(preferences.baseUrl + RESET_FIREBASE_TOKEN_ENDPOINT, MessagingRequest(preferences.firebaseDeviceToken))
            .doOnComplete { preferences.resetFirebase = false }
            .subscribe()
    }
