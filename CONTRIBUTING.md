...
Issues are created [here](https://github.com/EnAccess/micropowermanager-agent-app/issues/new).
...
1. By opening the issue for discussion: If you believe that you have found
   ...
   the [issue tracker](https://github.com/EnAccess/micropowermanager-agent-app/issues).
