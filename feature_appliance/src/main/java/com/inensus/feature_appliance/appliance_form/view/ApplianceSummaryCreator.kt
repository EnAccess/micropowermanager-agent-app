...
class ApplianceSummaryCreator(private val context: Context) {

    fun createSummaryItems(appliance: Appliance, firstPaymentDate: Date, downPayment: BigDecimal?, tenure: Int, amount: BigDecimal) =
        arrayListOf(
            KeyValue.Default(
